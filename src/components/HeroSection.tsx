      ...
      <div className="container mx-auto px-6 text-center z-10">
        ...
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="mb-8 relative">
            <div className="w-40 h-40 mx-auto rounded-full glass-card p-1 animate-glow-pulse">
              <div className="w-full h-full rounded-full bg-gradient-to-br from-neon-blue to-neon-violet flex items-center justify-center text-4xl font-bold text-white">
                DR
              </div>
            </div>
            <div className="absolute -top-4 -right-4 w-8 h-8 bg-green-500 rounded-full border-4 border-background animate-float"></div>
          </div>
